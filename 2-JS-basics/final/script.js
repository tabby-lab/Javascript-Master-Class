...
// Equality operators
// == means its equal to different data types eg: string '23' can equal number 23
// if (height === '23') {
...
function yearsUntilRetirement(year, firstName) {
    ...
    if (retirement > 0) {
        ...
        console.log(firstName + ' retires in ' + ' is already retired');
    }
...
//use dot notation to grab whatever element you want
